export const coowls = [
  ...
  },
  {
    ...
    identification: 'Boreal Owls are a relatively small owl, approximately 25 cm (10 in.) in length, with a wingspan of about 56 cm (22 in.). They have brown upperparts with numerous white spots and light underparts heavily streaked with chestnut-colored markings.',
  ...
  },
  {
    ...
    identification: 'Small and compact, with a large, circular head without ear tufts. Brown overall with fine white speckles on the head and white spots on the back. Note yellow eyes and bill.',
  ...
  },
  {
    ...
    identification: 'A tiny owl with a catlike face, oversized head, and bright yellow eyes. Adults have mottled brown and white plumage and a white V between the eyes, whereas juveniles are a distinctive cinammon color with brown faces.',
  ...
  },
  {
    ...
    identification: 'Medium-sized owl with long wings, a big head, and a short tail. Pale buffy overall with dark streaks and spots. Note the white patches at the wing tips easily visible in flight.',
